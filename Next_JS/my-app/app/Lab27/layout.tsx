...
function Lab27_Layout({children}:{children:React.ReactNode}) {
  return (
    <div>
       <div>
      <div className="row">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-black/40 backdrop-blur-xl border border-white/10 px-8 py-4 rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.5)] flex justify-between items-center">
              ...
              <div className="hidden md:flex items-center gap-2">
                 ...
                 <Link href="/Lab27" className="px-5 py-2 rounded-full text-slate-400 hover:text-white hover:bg-white/5 transition-all duration-300 text-sm font-medium">
                  Main Page
                </Link>
                <Link href="/Lab27/users/api" className="px-5 py-2 rounded-full text-slate-400 hover:text-white hover:bg-white/5 transition-all duration-300 text-sm font-medium">
                Users
                </Link>
                 <Link href="/Lab27/tasks/api" className="px-5 py-2 rounded-full text-slate-400 hover:text-white hover:bg-white/5 transition-all duration-300 text-sm font-medium">
                  ...
                  <Link href="/Lab27/tasks" className="px-5 py-2 rounded-full text-slate-400 hover:text-white hover:bg-white/5 transition-all duration-300 text-sm font-medium">
                  Task (Crud Prisma)
                </Link>
              </div>
