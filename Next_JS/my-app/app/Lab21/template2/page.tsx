          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            <div>
              ...
              <p className="text-xl text-slate-400 leading-relaxed max-w-md">
                We don't just build interfaces; we craft digital ecosystems that
                breathe and react to human intent.
              </p>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-900/50 backdrop-blur-2xl border border-white/10 p-12 rounded-[2.5rem] overflow-hidden">
                ...
                <p className="text-slate-400 leading-relaxed">
                  Our mission is to simplify complexity. By merging minimalist
                  aesthetics with robust architecture, we create the standard
                  for tomorrow's web.
                </p>
              </div>
            </div>
